#####################################################################################
#
# This script is installed along with the exposition/musium version of the Gears of  
# Yore video game for Windows. It is supposed to run in a background command line
# window, and automatically restarts the game executable after 10 seconds if the 
# player quits the game. The installer automatically places a shortcut to this 
# script on the current user's Windows Desktop.
#
...
$processName = "Gears_of_Yore"
$executablePath = "Gears_of_Yore.exe"
